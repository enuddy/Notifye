  ...
  this.reports = {
    ...
    compatibleFields: {
      ...
      query: function(params, callback) {
        var parameters = {
          options: {
            url: 'https://www.googleapis.com/dfareporting/v1.3/userprofiles/' + params.profileId + '/reports/compatiblefields/query',
            method: 'POST'
          },
          params: params,
          requiredParams: ['profileId'],
    ...
    files: {
      ...
      get: function(params, callback) {
        var parameters = {
          options: {
            url: 'https://www.googleapis.com/dfareporting/v1.3/userprofiles/' + params.profileId + '/reports/' + params.reportId + '/files/' + params.fileId,
            method: 'GET'
          },
          params: params,
      ...
      list: function(params, callback) {
        var parameters = {
          options: {
            url: 'https://www.googleapis.com/dfareporting/v1.3/userprofiles/' + params.profileId + '/reports/' + params.reportId + '/files',
            method: 'GET'
          },
          params: params,
          requiredParams: ['profileId', 'reportId'],
