...
function Adexchangebuyer(options) {
  ...
  this.accounts = {
    ...
    get: function(params, callback) {
      var parameters = {
        options: {
          url: 'https://www.googleapis.com/adexchangebuyer/v1.1/accounts/' + params.id,
          method: 'GET'
        },
        params: params,
        requiredParams: ['id'],
    ...
    list: function(params, callback) {
      var parameters = {
        options: {
          url: 'https://www.googleapis.com/adexchangebuyer/v1.1/accounts',
          method: 'GET'
        },
        params: params,
        context: self
  ...
  this.creatives = {
    ...
    get: function(params, callback) {
      var parameters = {
        options: {
          url: 'https://www.googleapis.com/adexchangebuyer/v1.1/creatives/' + params.accountId + '/' + params.buyerCreativeId,
          method: 'GET'
        },
        params: params,
    ...
    insert: function(params, callback) {
      var parameters = {
        options: {
          url: 'https://www.googleapis.com/adexchangebuyer/v1.1/creatives',
          method: 'POST'
        },
        params: params,
        context: self
  ...
  this.directDeals = {
    ...
    get: function(params, callback) {
      var parameters = {
        options: {
          url: 'https://www.googleapis.com/adexchangebuyer/v1.1/directdeals/' + params.id,
          method: 'GET'
        },
        params: params,
        requiredParams: ['id'],
    ...
    list: function(params, callback) {
      var parameters = {
        options: {
          url: 'https://www.googleapis.com/adexchangebuyer/v1.1/directdeals',
          method: 'GET'
        },
        params: params,
        context: self
